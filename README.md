<div align="center">
    <a href="https://nakshdev.tech"><h1 align="center">nakshdev.tech</h1></a>

My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=nakshdev.tech), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/).
...
```sh-session
git clone https://github.com/thenakshprajapat/my-portfolio.git
cd my-portfolio
```


Create a `.env` file for Upstash Redis (optional - site works without it).
